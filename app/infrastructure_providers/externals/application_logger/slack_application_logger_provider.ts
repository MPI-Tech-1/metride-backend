...
export default class SlackApplicationLoggerProvider implements ApplicationLoggerInterface {
  private webhookUrl: string = loggerConfig.slack.applicationLogWebhookUrl
