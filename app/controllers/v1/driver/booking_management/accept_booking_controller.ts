...
export default class AcceptBookingController {
  async handle({ auth, request, response }: HttpContext) {
    ...
    try {
      ...
      await NotificationDispatchClient.sendBookingDriverAcceptedNotificationJob({
    ...
    } catch (AcceptBookingControllerError) {
      console.log('AcceptBookingControllerError -> ', AcceptBookingControllerError)
      await logApplicationError(AcceptBookingControllerError)
