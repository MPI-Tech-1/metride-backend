...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('estimated_duration_in_seconds').defaultTo(0)
      table.integer('estimated_distance_in_meters').defaultTo(0)
      table.boolean('has_earning_been_credited_to_driver').defaultTo(false)
