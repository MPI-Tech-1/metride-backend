...
const RequestAccountActivationTokenController = () =>
  import('#controllers/v1/customer/account_activation/request_account_activation_token_controller')

const VerifyAccountActivationTokenController = () =>
  import('#controllers/v1/customer/account_activation/verify_account_activation_token_controller')
...
router
  ...
  .prefix('/api/v1/customers/account-activation')
