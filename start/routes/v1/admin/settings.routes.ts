...
const CreateCityController = () =>
  import('#controllers/v1/admin/settings/cities/create_city_controller')
const UpdateCityController = () =>
  import('#controllers/v1/admin/settings/cities/update_city_controller')
const FetchCitiesController = () =>
  import('#controllers/v1/admin/settings/cities/fetch_cities_controller')
